...
```{r}
#set.seed allows you to creat the same results every time
set.seed(123)
...
Assumptions: Both pops are normal distribution (bell curve)
...
#Different test using psych package
corr.test(PHQ9Pre, GAD7Pre)

PHQ9_GAD7Week7 = data.frame(PHQ9Pre, GAD7Pre, GAD7Post)
...
aov(GAD7PDiff ~ treatment, data = anovaDat)
